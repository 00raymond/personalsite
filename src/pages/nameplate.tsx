        ...
        <div className="to-slate-950 relative overflow-hidden rounded-xl border border-slate-800 bg-gradient-to-r from-slate-900 px-8 py-16 shadow-2xl">
            <div className="pointer-events-none absolute -inset-px opacity-0 transition duration-300"/>
                <div className={"flex space-x-3 items-center justify-center"}>
                    <img src={me} alt="me" className="w-48 h-48 rounded-xl shadow-lg border-2 border-slate-800"/>
                    <div className={"flex flex-col items-center justify-center"}>
                        <p className="tracking-tight font-medium text-3xl text-slate-200 ">
                            raymond house
                        </p>
                        ...
                        <div className={"flex items-center justify-center space-x-2 mt-1"}>
                            ...
                            <a href="https://linkedin.com/in/raymondbhouse" target="_blank" rel="noopener noreferrer">
                                <svg className="w-12 h-12 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                    <path fill-rule="evenodd" d="M12.51 8.796v1.697a3.738 3.738 0 0 1 3.288-1.684c3.455 0 4.202 2.16 4.202 4.97V19.5h-3.2v-5.072c0-1.21-.244-2.766-2.128-2.766-1.827 0-2.139 1.317-2.139 2.676V19.5h-3.19V8.796h3.168ZM7.2 6.106a1.61 1.61 0 0 1-.988 1.483 1.595 1.595 0 0 1-1.743-.348A1.607 1.607 0 0 1 5.6 4.5a1.601 1.601 0 0 1 1.6 1.606Z" clip-rule="evenodd"/>
                                    <path d="M7.2 8.809H4V19.5h3.2V8.809Z"/>
                                </svg>
                            </a>
                            <a href="mailto:raymondhouse2003@gmail.com" target="_blank" rel="noopener noreferrer">
                                <svg className="w-12 h-12 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
